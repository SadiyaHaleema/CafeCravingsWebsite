...
<html lang="en">
  ...
  <meta name="generator" content="Hugo 0.88.1" />
    ...
    <title>Campus Cravings | Terms and Conditions</title>
    <!--Favicon-->
...
@media (min-width: 62em) {
  ...
  <body>
    ...
    <div class="container">
      ...
      <p id="hd"><b>i. Introduction</b></p>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
      Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
       scrambled it to make a type specimen book. It has survived not only five centuries, , but also the leap into electronic typesetting, remaining 
      ...
      <p id="hd"><b>ii. Restrictions on use</b></p>
      <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
      Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
       scrambled it to make a type specimen book. It has survived not only five centuries, , but also the leap into electronic typesetting, remaining 
      essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently 
      ...
      <p id="hd"><b>iv. Termination</b></p>
      <p id="last">Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
      Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and
       scrambled it to make a type specimen book. It has survived not only five centuries, , but also the leap into electronic typesetting, remaining 
      essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently 
      with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.
    ...
    <!-- footer-->
            ...
            <a href="#"><img id="logo" src="restaurant.png" /></a>
            <br></br>
<!--Footer-->
<div class = "bottombar">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" >Terms and Conditions</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <h5>Services</h5>
        <ul class="nav flex-column">
          <li class="nav-item mb-2"><a href="#" >Services</a></li>
          <li class="nav-item mb-2"><a href="#" >Memberships and Coupons</a></li>
          <li class="nav-item mb-2"><a href="#" >Rewards</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <h5>Contact Us</h5>
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" >FAQ's</a></li>
          <li class="nav-item mb-2"><a href="#" >Pricing</a></li>
          <li class="nav-item mb-2"><a href="#" >Feedback</a></li>
        </ul>
      </div>
