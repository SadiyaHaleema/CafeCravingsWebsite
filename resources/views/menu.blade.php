        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
           ...
           <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <!--Buttons-->
            <div class="text-end">
              {{-- <i class="bi bi-cart4 px-2 text-white subtn cartbtn "></i> --}}
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
               <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z"/>
              </svg>
              <i>  <a  href="{{ route('viewcart') }}" class="px-2 text-white subtn cartbtn">Cart</a><span class="badge">{{ Session::has('cart')? Session::get('cart')->totalQty : ''}}</span> </i>
...
@endif 
        ...
        <div class="row mb-2">
          <div class="col-md-4 cartpage">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              <div class="col p-4 d-flex flex-column position-static">
                                {{-- <form id ="ajaxcall"  method="POST">  --}}
               ...
               <h3 class="mb-0"> {{ $product['itemname'] }}</h3>
                ...
                {{-- <td class="cart-product-quantity" width="150px">
                  <div class="input-group quantity">
                      ...
                      <input type="text" class="qty-input form-control" maxlength="2" max="8" value="{{ $product ['item_quantity'] }}">
                ...
                <button  type= "submit"  name="submit" id ="submitadd" class="add-to-cart-btn btn btn-warning subtn"  ><a href="{{ route('addtoCart',['id'=> $product['id']]) }}">Add to Cart</a> </button>
                ...
                {{-- <p class="card-text mb-auto"><button type="button" class="btn btn-warning subtn"><a href="{{ route('add.to.cart',$product->id) }}"><b>Add to cart</b></a></button></p>  --}}
          ...
          <div class="col-md-4">
            <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
              ...
              {{-- <form action="/addtocart" method="POST"> --}}
                  ...
                  <button class="btn btn-warning subtn"><a href="{{ route('addtoCart',['id'=> $product['id']]) }}">Add to Cart</a> </button>
                  {{-- <p class="card-text mb-auto">
                    <button type="button" class="btn btn-warning subtn">
                      <a href="#"><b>Add to cart</b></a></button></p> --}}
              ...
              {{-- </form> --}}
                ...
                <p class="card-text mb-auto">  <div class="flex-container">
                  <input type="button" id="remove_2" value="-"  onclick=Remove(this) />
                  <p id="number">&nbsp;&nbsp;&nbsp;0&nbsp;&nbsp;&nbsp;</p>
                  <input type="button" id="add_2" value="+"  onclick=Add(this) />
                  </div></p>
              </div>
              <div class="col-auto d-none d-lg-block">
                               <img class="bd-placeholder-img" src=" {{ $product['pictures'] }}" width="200" height="250">
...
<script>
      jQuery('#ajaxcall').submit(function(e)
        { 
        ...
        data:jQuery('#ajaxcall').serialize(),
        type:'post',

        success: function (result) {
         
         jQuery('#msg').html(result.success);
 } 
});
});
