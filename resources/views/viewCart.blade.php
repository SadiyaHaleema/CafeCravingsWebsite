...
{{-- New Template for shopping cart --}}
  ...
  <div class="container h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col">
        ...
        <p><span class="h2">Shopping Cart </span><span class="h4">({{ $product['qty'] }} item/items in your cart)</span></p>
        ...
        <div class="card mb-4">
          <div class="card-body p-4">
            ...
            <div class="row align-items-center">
              <div class="col-md-2">
                <img src="{{ $product['item']['pictures'] }}"
                  class="img-fluid" alt="Generic placeholder image" width="100" height="100">
              </div>
              <div class="col-md-2 d-flex justify-content-center">
                <div>
                  <p class="small text-muted mb-4 pb-2">Name</p>
                  <p class="lead fw-normal mb-0">{{ $product['item'] ['itemname'] }}</p>
                </div>
              </div>
              {{-- <div class="col-md-2 d-flex justify-content-center">
                <div>
              ...
              <div class="col-md-2 d-flex justify-content-center">
                <div>
                  ...
                  <p class="lead fw-normal mb-0">Rs. {{ $product['price'] }}</</p>
                </div>
              </div>
              <div class="col-md-2 d-flex justify-content-center">
                <div>
                  <p class="small text-muted mb-4 pb-2">Total</p>
                  <p class="lead fw-normal mb-0">Rs. {{ $totalPrice }}</</p>
                </div>
              </div>
            </div>
            @endforeach
            ...
            <div class="float-end">
              <p class="mb-0 me-5 d-flex align-items-center">
                <span class="small text-muted me-2">Order total:</span> <span
                  class="lead fw-normal">Rs. {{ $totalPrice }}</span>
              </p>
            </div>
        ...
        <div class="d-flex justify-content-end">
          <a href="{{ route('checkout')}}" type="button" class="btn btn-primary btn-lg">Checkout</a>
        </div>
